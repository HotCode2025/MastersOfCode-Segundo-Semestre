<script setup>
import proyecto1 from '/src/assets/oddo.jpg';
import proyecto2 from '/src/assets/opo.jpg';
import proyecto3 from '/src/assets/wordpress.jpg';
...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Sistema de Gestión de Inventarios (2025)",
        descripcion: "Desarrollamos un sistema web para la gestión de inventarios de una cadena de tiendas, utilizando Laravel y Vue.js",
        projectoLink: "https://www.odoo.com/es/app/inventory",
        githubLink: ""
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Aplicación de Reservas para Restaurantes (2025)",
        descripcion: "Creamos una aplicación móvil con Flutter que permite a los usuarios reservar mesas en restaurantes locales, consultar menús y recibir notificaciones sobre promociones especiales",
        projectoLink: "https://www.opentable.com/",
        githubLink: ""
    },
    {
        id: 3,
        src: proyecto3,
        titulo: "Blog Colaborativo con CMS (2024)",
        descripcion: "Desarrollamos un blog dinámico con sistema de gestión de contenidos (CMS) en WordPress, con un diseño moderno y adaptable a dispositivos móviles.",
        projectoLink: "https://wordpress.com/es/",
        githubLink: ""
    },
])
