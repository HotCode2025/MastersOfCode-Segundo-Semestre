class Vehiculo:
    ...
    Auto y Bicicleta, las culaes heredan de la clase padre Vehiculo. La clase
    ...
    -Metodos(__init__(color, ruedas y velocidad) y __str__())
...
# Primer objeto de la clase padre del vehiculo
